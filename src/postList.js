...
import {
  saveTask, deleteTask, getTask, updateTask, auth, db,
} from './firebase.js';
...
// console.log(querySnapshot)
  if (querySnapshot.length) {
        ...
        try {
          ...
          if (!likedPosts.includes(postId)) {
            ...
            if (postDoc) {
              ...
              } else if (postDoc.data().likes.includes(auth.currentUser.email)) {
    ...
    // BOTON ELIMINAR POSTS CON SU RESPECTIVO MODAL PARA LA CONFRIMACION
